...
def test_readme_contents():
    ...
    assert len(
        readme_words) >= 500, "Make your README.md file interesting! Add atleast 300 words"
...
def test_show_for_5_for_1_v_2():
    ...
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs straight Flush, royal flush should win"
...
def test_show_for_5_for_1_v_3():
    ...
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs 4 of a kind, royal flush should win"
...
def test_show_for_5_for_1_v_4():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs Full House, royal flush should win"
...
def test_show_for_5_for_1_v_5():
    ...
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs Flush, royal flush should win"
...
def test_show_for_5_for_1_v_6():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs straight, royal flush should win"
...
def test_show_for_5_for_1_v_7():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs 3 of a kind, royal flush should win"
...
def test_show_for_5_for_1_v_8():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['king hearts', 'king spades',
            'queen spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs 2 pair , royal flush should win"
...
def test_show_for_5_for_1_v_9():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['king clubs', 'king spades',
            'jack spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs 1 pair , royal flush should win"
...
def test_show_for_5_for_1_v_10():
    ...
    assert pxt.show(
        set1, set2) == '1', "Royal Flush vs high card, royal flush should win"
...
def test_show_for_5_for_2_v_1():
    ...
    set2 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    assert pxt.show(
        set1, set2) == '2', "straight Flush vs Royal Flush , straight flush should win"
...
def test_show_for_5_for_2_v_2():
    ...
    assert pxt.show(
        set1, set2) == '0', "straight Flush vs straight Flush should be a draw"
...
def test_show_for_5_for_2_v_3():
    ...
    assert pxt.show(
        set1, set2) == '1', "straight Flush vs 4 of a kind, straight flush should win"
...
def test_show_for_5_for_2_v_4():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['ace diamonds', 'ace hearts',
            'ace clubs', 'king clubs', 'king diamonds']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs Full House, straight flush should win"
...
def test_show_for_5_for_2_v_5():
    ...
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs Flush, straight flush should win"
...
def test_show_for_5_for_2_v_6():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['9 clubs', 'king diamonds',
            'queen clubs', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs straight, straight flush should win"
...
def test_show_for_5_for_2_v_7():
    set1 = ['9 hearts', '8 clubs', 'queen spades',
            'jack diamonds', '10 hearts']
    set2 = ['queen hearts', 'queen diamonds',
            'queen clubs', 'jack hearts', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs 3 of a kind, straight flush should win"
...
def test_show_for_5_for_2_v_8():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['king hearts', 'king clubs',
            'queen spades', 'queen hearts', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs 2 pair , straight flush should win"
...
def test_show_for_5_for_2_v_9():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['king clubs', 'king diamonds',
            'jack diamonds', 'queen hearts', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs 1 pair , straight flush should win"
...
def test_show_for_5_for_2_v_10():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['9 diamonds', 'king diamonds',
            '5 diamonds', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Straight Flush vs high card, straight flush should win"
...
def test_show_for_5_for_3_v_1():
    ...
    set2 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    assert pxt.show(
        set1, set2) == '2', "4 of a kind vs Royal Flush , 4 of a kind should win"
...
def test_show_for_5_for_3_v_2():
    ...
    set2 = ['9 hearts', '8 hearts', 'queen hearts', '10 hearts', 'jack hearts']
    assert pxt.show(
        set1, set2) == '2', "4 of a kind vs straight Flush,straight flush should win"
...
def test_show_for_5_for_3_v_3_s1gts2():
    ...
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs 4 of a kind, player 1 should win"
...
def test_show_for_5_for_3_v_3_s1lts2():
    ...
    assert pxt.show(
        set1, set2) == '2', "4 of a kind vs 4 of a kind, player 2 should win"
...
def test_show_for_5_for_3_v_4():
    ...
    set2 = ['ace diamonds', 'ace hearts',
            'ace clubs', 'king clubs', 'king diamonds']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs Full House, 4 of a kind should win"
...
def test_show_for_5_for_3_v_5():
    ...
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs Flush, 4 of a kind should win"
...
def test_show_for_5_for_3_v_6():
    ...
    set2 = ['9 clubs', 'king diamonds',
            'queen clubs', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs straight, 4 of a kind should win"
...
def test_show_for_5_for_3_v_7():
    ...
    set2 = ['queen hearts', 'queen diamonds',
            'queen clubs', 'jack hearts', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs 3 of a kind, 4 of a kind should win"
...
def test_show_for_5_for_3_v_8():
    set1 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 clubs']
    set2 = ['king hearts', 'king clubs',
            'queen spades', 'queen hearts', '10 diamonds']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs 2 pair , 4 of a kind should win"
...
def test_show_for_5_for_3_v_9():
    set1 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 clubs']
    set2 = ['king clubs', 'king diamonds',
            'jack diamonds', 'queen hearts', '10 diamonds']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs 1 pair , 4 of a kind should win"
...
def test_show_for_5_for_3_v_10():
    ...
    set2 = ['9 diamonds', 'king diamonds',
            '5 diamonds', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "4 of a kind vs high card, 4 of a kind should win"
...
def test_show_for_5_for_4_v_1():
    set1 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    set2 = ['ace spades', 'king spades',
            'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Full House vs Royal Flush, Roual Flush should be a draw"
...
def test_show_for_5_for_4_v_2():
    ...
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Full House vs straight Flush, Straight flush should win"
...
def test_show_for_5_for_4_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Full House vs 4 of a kind, 4 of a kind flush should win"


def test_show_for_5_for_4_v_4_s1lts2():
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    set1 = ['queen diamonds', 'queen clubs',
            '8 clubs', '8 spades', '8 diamonds']
    assert pxt.show(
        set1, set2) == '2', "Full House vs Full House,player 2 should win"


def test_show_for_5_for_4_v_4_s1gts2():
    set1 = ['ace spades', 'ace hearts',
            'king clubs', 'king spades', 'king diamonds']
    set2 = ['ace clubs', 'ace diamonds', 'queen clubs',
            'queen spades', 'queen diamonds']
    assert pxt.show(
        set1, set2) == '1', "Full House vs Full House, player 1 should win"
...
def test_show_for_5_for_4_v_5():
    ...
    set2 = ['9 spades', '2 spades', '3 spades', '4 spades', '7 spades']
    assert pxt.show(
        set1, set2) == '1', "Full House vs Flush, full house should win"
...
def test_show_for_5_for_4_v_6():
    ...
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Full House vs straight, full house should win"
...
def test_show_for_5_for_4_v_7():
    ...
    set2 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Full House vs 3 of a kind, full house should win"
...
def test_show_for_5_for_4_v_8():
    ...
    set2 = ['king hearts', 'king clubs',
            'queen spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Full House vs 2 pair , full house should win"


def test_show_for_5_for_4_v_9():
    set1 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    set2 = ['king clubs', 'king clubs',
            'jack spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Full House vs 1 pair , full house should win"
...
def test_show_for_5_for_4_v_10():
    ...
    set2 = ['9 spades', 'king diamonds', '5 spades', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Full House vs high card, full house should win"
...
def test_show_for_5_for_5_v_1():
    ...
    set2 = ['ace spades', 'king spades',
            'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Flush vs Royal Flush, Royal Flush SHould win"
...
def test_show_for_5_for_5_v_2():
    ...
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Flush vs straight Flush, Straight flush should win"
...
def test_show_for_5_for_5_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Flush vs 4 of a kind, 4 of a kind should win"
...
def test_show_for_5_for_5_v_4():
    ...
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    assert pxt.show(
        set1, set2) == '2', "Flush vs Full House, Full House should win"
...
def test_show_for_5_for_6_v_1():
    set1 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    set2 = ['ace spades', 'king spades',
            'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Straight vs Royal Flush, Royal Flush wins"
...
def test_show_for_5_for_6_v_2():
    ...
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Straight vs straight Flush, Straight flush should win"
...
def test_show_for_5_for_6_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "Straight vs 4 of a kind, 4 of a kind should win"
...
def test_show_for_5_for_6_v_4():
    ...
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    assert pxt.show(
        set1, set2) == '2', "Straight vs Full House, Full House should win"
...
def test_show_for_5_for_6_v_6_s1gts2():
    set1 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    set2 = ['9 clubs', '8 diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "Straight vs straight, player 1 should win"


def test_show_for_5_for_6_v_6_s1lts2():
    set1 = ['9 clubs', '8 diamonds',
            'queen spades', 'jack spades', '10 hearts']
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '2', "Straight vs straight, player 2 should win"


def test_show_for_5_for_6_v_6_s1eqs2():
    set1 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    set2 = ['9 hearts', 'king clubs',
            'queen diamonds', 'jack hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '0', "Straight vs straight, It should be a draw"
...
def test_show_for_4_for_6_v_6_s1eqs2():
    ...
    assert pxt.show(
        set1, set2) == '0', "Straight vs straight, It should be draw"
...
def test_show_for_5_for_6_v_7():
    ...
    set2 = ['queen hearts', 'queen diamonds',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Straight vs 3 of a kind, straight should win"
...
def test_show_for_5_for_6_v_8():
    set1 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    set2 = ['king hearts', 'king spades',
            'queen diamonds', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Straight vs 2 pair , straight should win"
...
def test_show_for_5_for_6_v_9():
    ...
    set2 = ['king clubs', 'king spades',
            'jack spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "Straight vs 1 pair , straight should win"
...
def test_show_for_5_for_6_v_10():
    ...
    assert pxt.show(
        set1, set2) == '1', "Straight vs high card, straight should win"
...
def test_show_for_5_for_7_v_1():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['queen diamonds', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "3 of a kind vs Royal Flush,Royal Flush should be a draw"
...
def test_show_for_5_for_7_v_2():
    set1 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs straight Flush, straight flush should win"
...
def test_show_for_5_for_7_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs 4 of a kind, 4 of a kind should win"
...
def test_show_for_5_for_7_v_4():
    ...
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs Full House, Full House should win"
...
def test_show_for_5_for_7_v_5():
    ...
    set2 = ['9 spades', '2 spades', '3 spades', '4 spades', '7 spades']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs Flush,  flush should win"
...
def test_show_for_5_for_7_v_6():
    set1 = ['queen hearts', 'queen diamonds',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs straight, straight should win"
...
def test_show_for_5_for_7_v_7_s1gts2():
    ...
    assert pxt.show(
        set1, set2) == '1', "3 of a kind vs 3 of a kind, player 1 should win"
...
def test_show_for_5_for_7_v_7_s1lts2():
    set1 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['king hearts', 'king spades',
            'king clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "3 of a kind vs 3 of a kind, player 2 should win"
...
def test_show_for_5_for_7_v_8():
    set1 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['king hearts', 'king spades',
            'jack diamonds', 'jack hearts', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "3 of a kind vs 2 pair , 3 of a kind should win"
...
def test_show_for_5_for_7_v_9():
    set1 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['king clubs', 'king spades',
            'jack spades', 'queen diamonds', '10 diamonds']
    assert pxt.show(
        set1, set2) == '1', "3 of a kind vs 1 pair , 3 of a kind should win"
...
def test_show_for_5_for_7_v_10():
    ...
    set2 = ['9 spades', 'king diamonds', '5 spades', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "3 of a kind vs high card, 3 of a kind should win"
...
def test_show_for_5_for_8_v_1():
    set1 = ['ace hearts', 'king hearts',
            'queen hearts', '10 hearts', 'jack hearts']
    set2 = ['king diamonds', 'king spades',
            'queen spades', 'queen clubs', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs Royal Flush, Royal Flush should be a draw"
...
def test_show_for_5_for_8_v_2():
    set1 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    set2 = ['king diamonds', 'king spades',
            'queen diamonds', 'queen clubs', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs straight Flush, straight flush should win"
...
def test_show_for_5_for_8_v_3():
    ...
    set2 = ['king diamonds', 'king spades',
            'queen spades', 'queen clubs', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs 4 of a kind,  4 of a kindshould win"
...
def test_show_for_4_for_8_v_3():
    ...
    set2 = ['king diamonds', 'king spades', 'queen spades', 'queen clubs']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs 4 of a kind,  4 of a kind should win"


def test_show_for_5_for_8_v_4():
    set1 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    set2 = ['king diamonds', 'king hearts',
            'queen spades', 'queen clubs', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs Full House, Full House should win"
...
def test_show_for_5_for_8_v_6():
    ...
    set2 = ['king diamonds', 'king spades',
            'queen spades', 'queen clubs', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs straight, straight should win"
...
def test_show_for_5_for_8_v_7():
    set1 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    set2 = ['king diamonds', 'king spades',
            '10 clubs', 'queen diamonds', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs 3 of a kind, 3 of a kind should win"
...
def test_show_for_5_for_8_v_8_s1gts2():
    set2 = ['jack diamonds', 'jack spades',
            'queen diamonds', 'queen clubs', '10 hearts']
    set1 = ['king hearts', 'king spades',
            'queen spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs 2 pair , player 1 should win"


def test_show_for_5_for_8_v_8_s1lts2():
    set1 = ['jack diamonds', 'jack spades',
            'queen diamonds', 'queen clubs', '10 hearts']
    set2 = ['king hearts', 'king spades',
            'queen spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "2 Pair vs 2 pair , player 2 should win"


def test_show_for_5_for_8_v_8_s1eqs2():
    set1 = ['king diamonds', 'king clubs',
            'queen diamonds', 'queen clubs', '10 hearts']
    set2 = ['king hearts', 'king spades',
            'queen spades', 'queen hearts', '9 spades']
...
def test_show_for_5_for_8_v_9():
    set1 = ['king diamonds', 'king spades',
            'queen spades', 'queen clubs', '10 clubs']
    set2 = ['king clubs', 'king hearts',
            'jack spades', 'queen hearts', '10 spades']
...
def test_show_for_5_for_8_v_10():
    ...
    assert pxt.show(
        set1, set2) == '1', "2 Pair vs high card, 2 Pair should win"
...
def test_show_for_5_for_9_v_1():
    ...
    assert pxt.show(
        set1, set2) == '1', "1 Pair vs Royal Flush, Royal Flush should win"
...
def test_show_for_5_for_9_v_2():
    set1 = ['king clubs', 'king spades',
            'jack clubs', 'queen hearts', '10 clubs']
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs straight Flush, straight flush should win"
...
def test_show_for_5_for_9_v_3():
    set1 = ['king clubs', 'king spades',
            'jack spades', 'queen hearts', '10 clubs']
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs 4 of a kind, 4 of a kind should win"
...
def test_show_for_5_for_9_v_4():
    set1 = ['king clubs', 'king spades',
            'jack spades', 'queen hearts', '10 spades']
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king hearts', 'king diamonds']
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs Full House, Full House should win"
...
def test_show_for_5_for_9_v_6():
    set1 = ['king clubs', 'king spades',
            'jack clubs', 'queen hearts', '10 spades']
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs straight, straight should win"
...
def test_show_for_5_for_9_v_7():
    ...
    set2 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs 3 of a kind, 3 of a kind should win"
...
def test_show_for_5_for_9_v_8():
    set1 = ['king clubs', 'king spades',
            'jack spades', 'queen clubs', '10 spades']
    set2 = ['king hearts', 'king diamonds',
            'queen spades', 'queen hearts', '10 spades']
...
def test_show_for_5_for_9_v_9_s1lts2():
    ...
    assert pxt.show(
        set1, set2) == '2', "1 Pair vs 1 pair , player 2 should win"
...
def test_show_for_5_for_9_v_9_s1eqs2():
    set1 = ['king clubs', 'king spades',
            'jack spades', 'queen hearts', '10 spades']
    set2 = ['king hearts', 'king diamonds',
            'jack spades', 'queen diamonds', '10 clubs']
    assert pxt.show(
        set1, set2) == '0', "1 Pair vs 1 pair , It should be a draw"
...
def test_show_for_5_for_9_v_10():
    ...
    set2 = ['9 spades', 'king diamonds', '5 spades', 'jack clubs', '10 hearts']
    assert pxt.show(
        set1, set2) == '1', "1 Pair vs high card, royal flush should win"
...
def test_show_for_5_for_10_v_1():
    ...
    assert pxt.show(
        set1, set2) == '1', "High Card vs Royal Flush, Royal Flush should  win"
...
def test_show_for_5_for_10_v_2():
    ...
    set2 = ['9 spades', '8 spades', 'queen spades', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "High Card vs straight Flush, straight flush should win"
...
def test_show_for_5_for_10_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 4 of a kind,  4 of a kind should win"
...
def test_show_for_4_for_10_v_3():
    ...
    set2 = ['7 hearts', '7 diamonds', '7 spades', '7 hearts']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 4 of a kind,  4 of a kindshould win"
...
def test_show_for_5_for_10_v_4():
    ...
    set2 = ['ace spades', 'ace hearts',
            'ace clubs', 'king spades', 'king diamonds']
    assert pxt.show(
        set1, set2) == '2', "High Card vs Full House, Full House should win"
...
def test_show_for_5_for_10_v_6():
    ...
    set2 = ['9 clubs', 'king diamonds',
            'queen spades', 'jack spades', '10 hearts']
    assert pxt.show(
        set1, set2) == '2', "High Card vs straight, straight should win"
...
def test_show_for_5_for_10_v_7():
    ...
    set2 = ['queen hearts', 'queen spades',
            'queen clubs', 'jack spades', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 3 of a kind, 3 of a kind should win"
...
def test_show_for_3_for_10_v_7():
    ...
    set2 = ['queen hearts', 'queen spades', 'queen clubs']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 3 of a kind, 3 of a kindh should win"
...
def test_show_for_5_for_10_v_8():
    ...
    set2 = ['king hearts', 'king spades',
            'queen spades', 'queen hearts', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 2 pair ,2 pair should win"
...
def test_show_for_5_for_10_v_9():
    ...
    set2 = ['king clubs', 'king spades',
            'jack spades', 'queen clubs', '10 spades']
    assert pxt.show(
        set1, set2) == '2', "High Card vs 1 pair , 1 pair should win"
...
def test_show_for_5_for_10_v_10_s1gts2():
    set1 = ['9 clubs', 'king diamonds',
            '5 hearts', 'jack diamonds', '10 hearts']
    set2 = ['9 spades', 'queen diamonds', '5 spades', 'jack clubs', '10 clubs']
    assert pxt.show(
        set1, set2) == '1', "High Card vs high card, player 1 should win"
...
def test_show_for_5_for_10_v_10_s1lts2():
    ...
    assert pxt.show(
        set1, set2) == '2', "High Card vs high card, player 2 should win"
...
def test_show_for_5_for_10_v_10_s1eqs2():
    ...
    assert pxt.show(
        set1, set2) == '0', "High Card vs high card, It should be a draw"
...
def test_poker_x_teen_patti_docs():
    assert bool(
        pxt.poker_x_teen_patti.__doc__), 'No DocString for poker_x_teen_patti'
...
def test_poker_x_teen_patti_annot():
    assert bool(
        pxt.poker_x_teen_patti.__annotations__), 'No Annotation for poker_x_teen_patti'
...
def test_transform_value_list_annot():
    assert bool(
        pxt.transform_value_list.__annotations__), 'No Annotation for transform_value_list'


def test_check_for_color_annot():
    assert bool(
        pxt.check_for_color.__annotations__), 'No Annotation for check_for_color'


def test_check_for_number_sequence_annot():
    assert bool(
        pxt.check_for_number_sequence.__annotations__), 'No Annotation for check_for_number_sequence'
